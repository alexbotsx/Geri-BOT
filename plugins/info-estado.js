...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const Message = {
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://chat.whatsapp.com/FEm8BZAVsUY45OCdbxKN6I?mode=r_c",
        mediaType: 2,
        previewType: "pdf",
        title: "GeriMiau",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://chat.whatsapp.com/FEm8BZAVsUY45OCdbxKN6I?mode=r_c",
      },
    },
    caption: info,
    footer: wm,
